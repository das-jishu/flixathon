...
<html lang="en">
    ...
    <body>
        ...
        <div style="margin-top: 100px;" class="container">
            ...
            <span style="background-color: Gold; padding: 5px; border-radius: 10px;">WATCHED</span></h1>
...
$.ajax({  
    ...
    success: function(response) {
            ...
            $('#show .elementfav').click(function() {
                ...
                $(this).find('.delete').click(function() {
                    ...
                    $.ajax({  
                        type: 'POST',  
                        url: './deletelist.php', 
                        data: { table: 'watched', movie_id: movie_id },
                        success: function(response) {
            ...
            var shareList = 'Hey! Check my watched list: \n\n';
            var i = 1;
